              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    <h4 className="mb-1 mb-sm-0">This is some importand announcement Alert</h4>
                    <p className="mb-0 font-weight-normal d-none d-sm-block">We will be coming live very very soon</p>
                  </div>
                  <div className="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                    <button className="btn btn-outline-light btn-rounded get-started-btn">Learn More</button>
                  </div>
                </div>
              </div>
            </div>
